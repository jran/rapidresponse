window.onload=function(){
	...
	query.find({
 		 success: function(results) {
    			...
    			var emergency = results[0];
			type = emergency.get("EmergencyType");
			description = emergency.get("Description");
			room = emergency.get("Location");
			building = emergency.get("Building");
	...
	document.getElementById('emergencytype').innerHTML= type;
